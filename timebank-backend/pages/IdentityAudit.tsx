...
import { IdentityAuditTask, AuditStatus, UserRole } from '../types';
                ...
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <h3 className="text-lg font-medium text-gray-900 flex items-center gap-2">
                      {task.userName}
                      {task.role && (
                        <Badge color={task.role === UserRole.ELDER ? 'green' : 'indigo'}>
                          {task.role}
                        </Badge>
                      )}
                    </h3>
              ...
              <div className="flex-1 space-y-6">
                <div className="bg-blue-50 p-4 rounded-md border border-blue-100">
                  ...
                  <dl className="grid grid-cols-1 gap-x-4 gap-y-4 sm:grid-cols-2">
                    ...
                    <div className="sm:col-span-1">
                      <dt className="text-xs font-medium text-blue-500 uppercase">注册身份</dt>
                      <dd className="mt-1 text-sm font-bold text-gray-900">
                        {selectedTask.role && (
                          <Badge color={selectedTask.role === UserRole.ELDER ? 'green' : 'indigo'}>
                            {selectedTask.role}
                          </Badge>
                        )}
                      </dd>
