            ...
            <div className="flex-1 flex gap-6 overflow-hidden">
                ...
                <div className="w-1/2 flex flex-col gap-4 overflow-y-auto pr-2">
                    ...
                    <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100 flex-1">
                        <h3 className="font-bold text-gray-800 mb-3 border-b pb-2">履约凭证 / 证据照片</h3>
                        <div className="grid grid-cols-2 gap-4">
                            {arbitration.evidenceImages && arbitration.evidenceImages.length > 0 ? (
                                arbitration.evidenceImages.map((img, idx) => (
                                    <div key={idx} className="group relative border rounded-lg overflow-hidden h-40 bg-gray-100 cursor-pointer" onClick={() => openViewer(img)}>
                                ...
                                <div className="col-span-2 text-gray-400 text-center py-4">无证据图片</div>
                            )}
                        </div>
                    </div>
                </div>
                    ...
                    <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100 flex-1 overflow-y-auto">
                        ...
                        {arbitration.defendantResponse ? (
                            <div className="flex flex-col items-end mb-6">
                                ...
                                <div className="bg-blue-50 p-3 rounded-tl-lg rounded-bl-lg rounded-br-lg border border-blue-100 text-gray-800 text-sm text-right w-full">
                                    {arbitration.defendantResponse}
                                </div>
                            </div>
                        ) : (
